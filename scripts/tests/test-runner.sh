...
echo -e "${BOLD}${CYAN}║          yw_lab LAB - COMPREHENSIVE TEST SUITE                    ║${ENDCOLOR}"
...
{
    echo "════════════════════════════════════════════════════════════════════"
    echo "yw_lab LAB - TEST SUITE REPORT"
    echo "════════════════════════════════════════════════════════════════════"
    echo ""
...
<html>
<head>
    <title>yw_lab Test Report</title>
    <style>
        body {
...
<body>
    <div class="header">
        <h1>yw_lab Lab - Test Suite Report</h1>
