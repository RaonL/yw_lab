...
# =========================
log_section "Starting yw_lab Deployment"
...
#    log_info "Restarting IDS containers (waiting for interfaces)..."
#    docker restart clab-yw-DMZ_IDS clab-yw-Internal_IDS 2>/dev/null || true
#    sleep 15
