...
# Backend/SIEM spans multiple 10.0.3.x /30 links, not just 10.0.3.0/30.
export SUBNET_BACKEND="10.0.3.0/24"
...
mkdir -p "${LOG_DIR}" "${TOPOLOGY_DIR}" "${CONFIG_DIR}" 2>/dev/null || trueexport EDGE_ROUTER_ETH2_IP="${ROUTER_EDGE_ETH2_IP}"
